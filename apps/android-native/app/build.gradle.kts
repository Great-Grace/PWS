...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "EXPO_PUBLIC_SUPABASE_URL", quotedBuildConfig(System.getenv("EXPO_PUBLIC_SUPABASE_URL")))
        buildConfigField("String", "EXPO_PUBLIC_SUPABASE_ANON_KEY", quotedBuildConfig(System.getenv("EXPO_PUBLIC_SUPABASE_ANON_KEY")))
        buildConfigField("String", "EXPO_PUBLIC_TEST_PASSWORD", quotedBuildConfig(System.getenv("EXPO_PUBLIC_TEST_PASSWORD")))
    }
